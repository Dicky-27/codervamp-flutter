...
class BentoWidget extends StatefulWidget {
  const BentoWidget({super.key});

  @override
  State<BentoWidget> createState() => _BentoWidgetState();
}

class _BentoWidgetState extends State<BentoWidget> {
                ...
                child: StaggeredGrid.count(
                  ...
                  children: getFilteredMenus().map((Menu menu) {
                    ...
                    final int mainAxisCellCount =
                        mainAxisCell3Index.contains(index)
                            ? 2
